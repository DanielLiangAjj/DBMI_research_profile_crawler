...
def scrape_profile(profile_url, department, retries = 3, wait_time = 3):
    ...
    while try_count < retries:
        try:
            ...
            if research_intro == "N/A" and name == "N/A" and department != "Physiology and Cellular Biophysics" and department != "Systems Biology":
            ...
            if research_intro == "N/A" and name == "N/A" and department == "Physiology and Cellular Biophysics":
            ...
            if research_intro == "N/A" and name == "N/A" and department == "Systems Biology":
